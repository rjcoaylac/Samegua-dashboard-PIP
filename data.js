const dashboardData = {
  ...
  ranking: [
    { municipalidad: "Samegua", avance: 6.6, color: "#10B981" },
    { municipalidad: "Otra Distrital 1", avance: 20.9 },
    { municipalidad: "Otra Distrital 2", avance: 13.7 },
    { municipalidad: "Otra Distrital 3", avance: 6.6 },
    { municipalidad: "Otra Distrital 4", avance: 4.0 }
    // Agrega más si tienes nombres exactos de la captura
  ],
  funciones: [
  ...
  proyectos: [
    ...
    { nombre: "Mejora transitabilidad calles principales", pim: 637705, devengado: 0, avance: 0 },
    ...
    // Agrega 5-10 más clave si quieres; el resto se puede resumir en "Otros"
    { nombre: "Otros proyectos pequeños", pim: 5000000, devengado: 500000, avance: 10 }
  ]
};
